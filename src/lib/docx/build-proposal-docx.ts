...
import { renderProposalDocxBuffer, type ProposalDocxData } from "./proposal-document";

export async function buildProposalDocxData(
  supabase: SupabaseClient<Database>,
  id: string,
): Promise<{ data: ProposalDocxData; fileLabel: string } | null> {
...
export { renderProposalDocxBuffer };
