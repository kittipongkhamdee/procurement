...
import { createProposal, deleteProposal, updateProposalStatus } from "./actions";
    ...
    <div>
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">
            เขียนข้อเสนอโครงการตามแนวทาง สพฐ. เพื่อเสนอกลุ่มบริหารงบประมาณพิจารณา
          </p>
        </div>
        {currentYear && (
          <Modal
      ...
      <div className="card mb-4 flex items-start gap-3 bg-navy-950/[0.03]">
        ...
        <p className="text-sm text-slate-600">
          เมื่อผู้บริหารเห็นชอบข้อเสนอโครงการนี้แล้ว ให้นำไปบันทึกเป็นโครงการจริงในเมนู
          &quot;โครงการ&quot; เพื่อกำหนดงบประมาณและกิจกรรมย่อยต่อไป
        </p>
      </div>
